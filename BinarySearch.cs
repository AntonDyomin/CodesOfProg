...

{
...

    {
        ...
        private static void TestOneNumbers()
        {
            ...
            if (BinarySearch(oneNumber, 4) != 3)
                Console.WriteLine("! Поиск не нашел число 4 среди чисел {1, 2, 3, 4, 5}");
            else
        ...
        private static void TestRepeatNumbers()
        {
            ...
            int[] repeatNumbers = { 1, 2, 3, 4, 4, 5 };
            var ind = BinarySearch(repeatNumbers, 4);
            if (repeatNumbers[ind] != 4)
        ...
        private static void TestEmptyNumbers()
        {
            ...
            int[] emptyNumbers = { };
            if (BinarySearch(emptyNumbers, 3) != -1)
                Console.WriteLine("! Поиск нашёл число 3 среди чисел {}");
            else
